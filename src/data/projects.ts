...
export const projects: Project[] = [
  {
    ...
    techStack: ['Python', 'LangGraph', 'FastAPI', 'BM25', 'HyDE', 'CRAG', 'RAGAS', 'FAISS'],
    githubUrl: 'https://github.com/Cosmonaut-ene/UNSW_RAG_Assistance',
  },
  {
    title: 'Jobseeking Agent — Multi-Agent System',
    description:
      'Self-built 4-agent automation system (Scout / Tailor / Applier / Advisor) for AI job hunting. FastAPI backend, Next.js dashboard, Playwright browser automation, Discord webhook notifications, GitHub Actions CI/CD on a self-hosted Ubuntu VPS.',
    techStack: ['Multi-Agent', 'FastAPI', 'Next.js', 'Playwright', 'Docker', 'GitHub Actions', 'Discord API', 'APScheduler'],
